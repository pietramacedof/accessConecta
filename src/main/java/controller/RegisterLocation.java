...
public class RegisterLocation extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		   ...
		   System.out.println("Informações do local:" + locationName + ", " + postalCode + ", " + street + ", " + neighborhood + ", " + number + ", " + city + ", " + state + ", " + establishmentType);
		   if(establishmentType.equalsIgnoreCase("restaurant")) {
			   String cuisineType = request.getParameter("cuisineType");
			   String operatingDays = request.getParameter("operatingDays");

			   Restaurant restaurant = new Restaurant(street, neighborhood, city, state, locationName, postalCode, number, cuisineType, operatingDays);
			...
			try {
			   ...
			   Event event = new Event(street, neighborhood, city, state, locationName, postalCode, number, startDate, endDate, eventPrice);
