...
document.addEventListener('DOMContentLoaded', function () {console.log("loads")
	...
	const location = document.querySelectorAll('location-info');
	...
	const alterPasswordModal = document.getElementById('toAlterPassword');
	...
	lightModeIcon && lightModeIcon.addEventListener('click', function () {
		...
		alterPasswordModal && alterPasswordModal.classList.remove('dark-mode');
		...
		location.forEach(location => {
   			 location.classList.remove('dark-mode');
		});
	...
	darkModeIcon && darkModeIcon.addEventListener('click', function () {
		...
		alterPasswordModal && alterPasswordModal.classList.add('dark-mode');
		locationInfo && locationInfo.classList.add('dark-mode');
		sections.forEach(function (section) {
			section.classList.add('dark-mode');
		});
		location.forEach(location => {
   			 location.classList.add('dark-mode');
		});
...
document.addEventListener('DOMContentLoaded', function () {
	var togglePassword = document.getElementById('toggleAlterPassword');
	togglePassword && togglePassword.addEventListener('click', function (e) {
		// Previne o comportamento padrão do ícone
		e.preventDefault();
...
document.addEventListener('DOMContentLoaded', function () {
	var togglePassword = document.getElementById('toggleConfirmPassword');
	togglePassword && togglePassword.addEventListener('click', function (e) {
		// Previne o comportamento padrão do ícone
		e.preventDefault();

		// Alterna o tipo do campo de senha
		var password = document.getElementById('userConfirmPassword');
		var type = password.getAttribute('type') === 'password' ? 'text' : 'password';
		password && password.setAttribute('type', type);
...
document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('input[type=radio][name="userType"]').forEach(function (radio) {
            radio.addEventListener('change', function () {
                var disabilityInput = document.getElementById('contentTypeOfDisability');
...
function applyTransition(shouldApply) {
  const slides = document.querySelectorAll('.slide');
  slides.forEach((slide) => {
    if (shouldApply) {
      slide.classList.add('transition-effect');
    } else {
      slide.classList.remove('transition-effect');
    }
  });
}
...
function updateNightMode() {
  ...
  const elementsToInvert = document.querySelectorAll('.invert-colors');

  if (nightMode) {
    body.classList.add('night-mode');
    imageCarousel.classList.add('night-mode');
    elementsToInvert.forEach((element) => {
      element.classList.add('invert');
    });
  } else {
    body.classList.remove('night-mode');
    imageCarousel.classList.remove('night-mode');
    elementsToInvert.forEach((element) => {
...
function toggleNightMode() {
  nightMode = nightModeSwitch.checked;
  updateNightMode();
}